...
public class ReportInventory {
	...
	public ReportInventory(Player player, Report report) {
		...
		MenuInventory menu = new MenuInventory(
				Translate.getTranslation(lang, "report-inv").replace("%reported%", report.getPlayerName()), 54);
		...
		menu.setItem(40, new ItemBuilder().type(Material.BOOK_AND_QUILL).name("§%report-list%§").lore(listLore).build(),
		...
		menu.setItem(42, new ItemBuilder().type(Material.REDSTONE_BLOCK).name("§%reject-report%§").build(),
				new MenuClickHandler() {
