...
public class PackageCommand implements CommandClass {
	...
	@Command(name = "givevip", usage = "/<command> <player> <tempo> <group>", groupToUse = Group.DONO, aliases = { "darvip" }, noPermMessageId = "command-givevip-no-access")
	public void givevip(BungeeCommandArgs cmdArgs) {
		...
		final String giveVipPrefix = T.t(BungeeMain.getPlugin(), lang, "command-givevip-prefix") + " ";
		if (args.length != 3) {
			sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), lang, "command-givevip-usage").replace("%command%", cmdArgs.getLabel())));
			return;
		}
		UUID uuid = BattlebitsAPI.getUUIDOf(args[0]);
		if (uuid == null) {
			sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "player-not-exist")));
			return;
		}
		...
		if (player == null) {
			try {
				...
				e.printStackTrace();
				sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "cant-request-offline")));
				return;
			}
			if (player == null) {
				sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "player-never-joined")));
				return;
			}
		}
		...
		try {
			...
			sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "invalid-format")));
			return;
		}
		...
		try {
			...
			sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "command-givevip-rank-not-exist")));
			return;
		}
		...
		String message = giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "command-givevip-added");
	...
	@Command(name = "removevip", usage = "/<command> <player> <group>", groupToUse = Group.DONO, aliases = { "removervip" }, noPermMessageId = "command-removevip-no-access")
	public void removevip(BungeeCommandArgs cmdArgs) {
		...
		final Language language = lang;
		final String giveVipPrefix = T.t(BungeeMain.getPlugin(), lang, "command-removevip-prefix") + " ";
		if (args.length != 2) {
			sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), lang, "command-removevip-usage").replace("%command%", cmdArgs.getLabel())));
			return;
		}
		UUID uuid = BattlebitsAPI.getUUIDOf(args[0]);
		if (uuid == null) {
		...
		try {
			...
			sender.sendMessage(TextComponent.fromLegacyText(giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "command-removevip-rank-not-exist")));
			return;
		}
		...
		String message = giveVipPrefix + T.t(BungeeMain.getPlugin(), language, "command-removevip-removed");
		message = message.replace("%player%", player.getName() + "(" + player.getUniqueId().toString().replace("-", "") + ")");
		message = message.replace("%rank%", rank.name());
		sender.sendMessage(TextComponent.fromLegacyText(message));
	}
	...
	public void doublexpadd(BungeeCommandArgs cmdArgs) {
		...
		final Language language = lang;
		final String groupSetPrefix = T.t(BungeeMain.getPlugin(), lang, "command-doublexpadd-prefix") + " ";
		if (args.length != 2) {
			sender.sendMessage(TextComponent.fromLegacyText(groupSetPrefix + T.t(BungeeMain.getPlugin(), lang, "command-doublexpadd-usage").replace("%command%", cmdArgs.getLabel())));
			return;
		}
		int doublexp = 0;
		try {
		...
		UUID uuid = BattlebitsAPI.getUUIDOf(args[0]);
		if (uuid == null) {
			sender.sendMessage(TextComponent.fromLegacyText(groupSetPrefix + T.t(BungeeMain.getPlugin(), language, "player-not-exist")));
			return;
		}
		BattlePlayer player = BattlebitsAPI.getAccountCommon().getBattlePlayer(uuid);
		if (player == null) {
			try {
				...
				e.printStackTrace();
				sender.sendMessage(TextComponent.fromLegacyText(groupSetPrefix + T.t(BungeeMain.getPlugin(), language, "cant-request-offline")));
				return;
			}
			if (player == null) {
				sender.sendMessage(TextComponent.fromLegacyText(groupSetPrefix + T.t(BungeeMain.getPlugin(), language, "player-never-joined")));
				return;
			}
		}
		player.addDoubleXpMultiplier(d);
		String message = groupSetPrefix + T.t(BungeeMain.getPlugin(), language, "command-doublexpadd-add-success");
		message = message.replace("%player%", player.getName() + "(" + player.getUniqueId().toString().replace("-", "") + ")");
		sender.sendMessage(TextComponent.fromLegacyText(message));
	}
	...
	public void torneioadd(BungeeCommandArgs cmdArgs) {
		...
		final Language language = lang;
		final String groupSetPrefix = T.t(BungeeMain.getPlugin(), lang, "command-torneio-prefix") + " ";
		if (args.length != 1) {
			sender.sendMessage(TextComponent.fromLegacyText(groupSetPrefix + T.t(BungeeMain.getPlugin(), lang, "command-torneio-usage").replace("%command%", cmdArgs.getLabel())));
			return;
		}
		UUID uuid = BattlebitsAPI.getUUIDOf(args[0]);
		if (uuid == null) {
		...
		String message = groupSetPrefix + T.t(BungeeMain.getPlugin(), language, "command-torneio-add-success");
		message = message.replace("%player%", player.getName() + "(" + player.getUniqueId().toString().replace("-", "") + ")");
		sender.sendMessage(TextComponent.fromLegacyText(message));
	}
	...
	public void torneioremove(BungeeCommandArgs cmdArgs) {
		...
		String message = groupSetPrefix + T.t(BungeeMain.getPlugin(), language, "command-torneio-remove-success");
		message = message.replace("%player%", player.getName() + "(" + player.getUniqueId().toString().replace("-", "") + ")");
		sender.sendMessage(TextComponent.fromLegacyText(message));
	}
